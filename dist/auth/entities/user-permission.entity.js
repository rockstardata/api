...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.permissions, { onDelete: 'CASCADE' }),
    __metadata("design:type", user_entity_1.User)
], UserPermission.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: permission_type_enum_1.PermissionType,
    }),
    __metadata("design:type", String)
], UserPermission.prototype, "permissionType", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
    ...
    __metadata("design:type", String)
], UserPermission.prototype, "resourceType", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], UserPermission.prototype, "resourceId", void 0);
exports.UserPermission = UserPermission = __decorate([
    (0, typeorm_1.Entity)(),
    (0, typeorm_1.Unique)(['user', 'permissionType', 'resourceType', 'resourceId'])
], UserPermission);
