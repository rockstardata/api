...
export declare class PermissionsService {
    ...
    constructor(permissionRepository: Repository<UserPermission>, userRepository: Repository<User>, organizationRepository: Repository<Organization>, venueRepository: Repository<Venue>, companyRepository: Repository<Company>);
    ...
    assignSalesPermissionToCompany(userId: number, companyId: number, permissionType?: PermissionType): Promise<UserPermission>;
