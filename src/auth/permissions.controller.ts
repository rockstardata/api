...
export class PermissionsController {
  ...
  @ApiOperation({ 
    ...
    description: 'Assign a specific permission to a user for a resource. Only SuperAdmin can assign permissions.'
  })
  @ApiResponse({ 
    status: 201, 
  ...
  @ApiOperation({ 
    ...
    description: 'Assign multiple permissions to a user based on their role. Only SuperAdmin can assign role-based permissions.'
  })
  @ApiResponse({ 
    status: 201, 
  ...
  @ApiOperation({ 
    ...
    description: 'Assign sales-related permissions to a user in an organization. Only SuperAdmin can assign permissions.'
  })
  @ApiQuery({ 
    name: 'permissionType', 
    required: false, 
  ...
  @ApiOperation({ 
    ...
    description: 'Assign sales-related permissions to a user in a company. Only SuperAdmin can assign permissions.'
  })
  @ApiQuery({ 
    name: 'permissionType', 
    required: false, 
  ...
  @ApiOperation({ 
    ...
    description: 'Assign sales-related permissions to a user in a venue. Only SuperAdmin can assign permissions.'
  })
  @ApiQuery({ 
    name: 'permissionType', 
    required: false, 
  ...
  @ApiOperation({ 
    ...
    description: 'Remove a specific permission from a user. Only SuperAdmin can remove permissions.'
  })
  @ApiQuery({ 
    name: 'permissionType', 
    required: true, 
  ...
  @ApiOperation({ 
    ...
    description: 'Remove all permissions from a user. Only SuperAdmin can remove all permissions.'
  })
  @ApiResponse({ 
    status: 200, 
