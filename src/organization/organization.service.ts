...
export class OrganizationService {
  ...
  async create(createOrganizationDto: CreateOrganizationDto) {
    ...
    this.syncService
      .syncEntity('Organization', 'create', savedOrganization)
      .catch((error) => {
        console.error(
          'Failed to sync organization creation to external DB:',
          error,
        );
      });
  ...
  async update(id: number, updateOrganizationDto: UpdateOrganizationDto) {
    ...
    // Sincronizar con base de datos externa de forma asíncrona
    this.syncService
      .syncEntity('Organization', 'update', updatedOrganization)
      .catch((error) => {
        console.error(
          'Failed to sync organization update to external DB:',
          error,
        );
      });
  ...
  async remove(id: number) {
    ...
    this.syncService
      .syncEntity('Organization', 'delete', { id })
      .catch((error) => {
        console.error(
          'Failed to sync organization deletion to external DB:',
          error,
        );
      });
  }
  ...
  async assignUserToOrganization(orgId: number, userId: number) {
    ...
    const existing = await this.organizationUserRepository.findOne({
